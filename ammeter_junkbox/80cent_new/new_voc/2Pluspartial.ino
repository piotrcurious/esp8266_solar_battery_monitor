...
#define PARTIAL_MEASUREMENT_INTERVAL 2000 // Interval for partial VOC measurement

// RC fitting parameters
#define NUM_SAMPLES 20 // Number of samples for FULL RC fitting
#define PARTIAL_SAMPLES NUM_SAMPLES/10 // Number of samples for PARTIAL RC measurement
...
#define DIVERGENCE_THRESHOLD 0.02 // Threshold for divergence detection (adjust based on voltage scale and noise)
...
#define MIN_CALIBRATION_INTERVAL CALIBRATION_INTERVAL/2 // Minimum calibration interval
...
// Function to fit RC profile using Gradient Descent (same as before)
bool fit_rc_profile() {
...
void debug_output(){
    ...
    Serial.print(calibration_interval_current);
    Serial.println();
}
