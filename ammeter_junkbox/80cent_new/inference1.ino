...
float panelCurrent, inferredCurrent;
...
// Function to infer panel current based on Voc and panel voltage drop
float inferCurrent(float measuredVoltage, float voc) {
  ...
  float inferredCurrent = voltageDrop / voc;  // Simple linear inference
