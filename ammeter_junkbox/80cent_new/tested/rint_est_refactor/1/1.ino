...
private:
    ...
    // Timing variables
    unsigned long last_calibration_time =  CALIBRATION_INTERVAL;
    ...
    void adjustLoad() {
        ...
        pwm_instance->setPWM( PWM_PIN,  FREQ_MAX, pwm_value);
    }
...
public:
    ...
    void begin() {
        ...
        pwm_instance = new AVR_PWM( PWM_PIN,  FREQ_MAX,  MIN_PWM);
        if (pwm_instance) {
            pwm_instance->setPWM();
    ...
    void calibrate() {
        pwm_instance->setPWM( PWM_PIN,  FREQ_MAX,  MIN_PWM);
