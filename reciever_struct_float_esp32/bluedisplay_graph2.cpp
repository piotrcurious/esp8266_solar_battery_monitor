...
float dataArray[] = {0.1, 0.3, NAN, 0.7, 0.8, 0.9, NAN, 1.2, 1.3, 1.4, 1.5, 1.7, 2.0, NAN, 2.2, 2.3, 2.4, 2.5};  // Example array of float data
const int dataArraySize = sizeof(dataArray) / sizeof(dataArray[0]);

float graph_min = 0.0;  // Minimum Y value for the graph
float graph_max = 2.5;  // Maximum Y value for the graph
