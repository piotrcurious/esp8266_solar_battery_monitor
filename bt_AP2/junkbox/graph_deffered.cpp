...
// Modified plotGraph function with buffer reset
...
// Example usage of drawing a random subset of buffered lines
void executeRandomGraphDrawing(int numLinesToDraw) {
    drawRandomLines(numLinesToDraw);
}
