 ...
 * 
 * Generates dynamic ASCII art during compilation based on pin mappings.
 */
...
#define EXPAND(x) x
#define PRINT_PIN_MAPPING(pin_map) EXPAND(pin_map)
...
#pragma message("  +----------------------------------+")
#pragma message("  | " PRINT_PIN_MAPPING(PIN_3V3_MAP) "   " PRINT_PIN_MAPPING(PIN_RST_MAP)  " |")
#pragma message("  | " PRINT_PIN_MAPPING(PIN_D0_MAP)  "   " PRINT_PIN_MAPPING(PIN_A0_MAP)   " |")
#pragma message("  | " PRINT_PIN_MAPPING(PIN_D1_MAP)  "   " PRINT_PIN_MAPPING(PIN_G_MAP)    " |")
#pragma message("  | " PRINT_PIN_MAPPING(PIN_D2_MAP)  "   " PRINT_PIN_MAPPING(PIN_5V_MAP)   " |")
#pragma message("  | " PRINT_PIN_MAPPING(PIN_D3_MAP)  "   " PRINT_PIN_MAPPING(PIN_D8_MAP)   " |")
#pragma message("  | " PRINT_PIN_MAPPING(PIN_D4_MAP)  "   " PRINT_PIN_MAPPING(PIN_D7_MAP)   " |")
#pragma message("  | " PRINT_PIN_MAPPING(PIN_D5_MAP)  "   " PRINT_PIN_MAPPING(PIN_D6_MAP)   " |")
#pragma message("  | " PRINT_PIN_MAPPING(PIN_GND_MAP) "   " PRINT_PIN_MAPPING(PIN_3V3B_MAP) " |")
#pragma message("  +----------------------------------+")
