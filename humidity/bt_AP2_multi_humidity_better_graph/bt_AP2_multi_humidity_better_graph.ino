...
void scheduleGraphMulti(uint16_t dataSize, uint16_t graphPosX, uint16_t graphPosY,
                  uint16_t graphWidth, uint16_t graphHeight, uint8_t graph_index) {
...
void scheduleGraphSingle(uint8_t data_pointer, uint16_t dataSize, uint16_t graphPosX, uint16_t graphPosY,
                  uint16_t graphWidth, uint16_t graphHeight, float graph_min, float graph_max, color16_t graphColor, bool clear_under , uint8_t graph_index) {
...
void drawLinesUsingLFSR(int numLinesToDraw, uint8_t graph_index) {
    uint16_t linesDrawn = 0;
    bool wrapped = false;
